    ...
    <footer className="w-full py-14 ">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
            {
              userToken ? 
              <>
              <li><Link to={'/'} className="p-1 font-sans font-normal leading-normal capitalize">home</Link></li>
              <li><Link to={'products'} className="p-1 font-sans font-normal leading-normal capitalize">products</Link></li>
              <li><Link to={'categories'} className="p-1 font-sans font-normal leading-normal capitalize">categories</Link></li>
              <li><Link to={'brands'} className="p-1 font-sans font-normal leading-normal capitalize">brands</Link></li>
              <li><Link to={'cart'} className="p-1 font-sans font-normal leading-normal capitalize">carts</Link></li>
              <li><Link to={'wishlist'} className="p-1 font-sans font-normal leading-normal capitalize">wishlist</Link></li>
              </> : 
              <>
              <Link to={'/login'}>
              <button className="px-4 py-2 font-sans text-sm font-semibold uppercase align-middle transition-all rounded-lg select-none hover:bg-gray-900/10 
              active:bg-gray-900/20" type="button">
                Log In
              </button>
              </Link>
              <Link to={'/register'}>
          ...
          <span className="text-lg text-gray-500 text-center block">©<Link to={'/'}>Fresh Cart</Link> 2024, All rights reserved.</span>
        </div>
      </div>
    </footer>                                
    </>
